    ...
    return (
        <div>
            <div className="d-flex justify-content-between aign-items center">
                <h5 className="card-title h4"><u>Pharmacy List Returns</u></h5>
            ...
            <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
                ...
                <div className=" d-flex text-center gap-3">
                    ...
                    <Link to='/Patient-Amdn' className="btn btn-primary">Check Patient List</Link>
                    ...
                    <Link to='/patient-list' className="btn btn-secondary"><DollarOutlined className='px-2'/>Charges</Link>
                    <Link to='/Patient-Amdn' className="btn btn-primary"><BiEdit style={{color:'#fff'}} className=''/> Edit List</Link>
...
export default PharmacylListReturns;