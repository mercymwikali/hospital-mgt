  ...
  return (
    <div>
      <div className="d-flex justify-content-between aign-items center">
        <h5 className="card-title h4"><u>Ward Management</u></h5>
      ...
      <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
        ...
        <div className=" d-flex text-center gap-3">
          ...
          <Link to='/patient-list' className="btn btn-primary">Admission List</Link>
          <Link to='/patient-list' className="btn btn-success">Release Bed</Link>
          <Link to='/patient-list' className="btn btn-secondary">Bed Transfer</Link>
      ...
      <div className="table-responsive-lg">
        <div className="d-flex justify-content-between align-items-center my-3">
          <Select className='w-25' placeholder='Search by . . . ' onSearch={(value) => {
            ...
            <option value='1' defaultValue={1}>My Patient</option>
            <option value='Admission No'>Clinic</option>
            <option value='Name'>Optical</option>
            <option value='Name'>Dental</option>
          </Select>
