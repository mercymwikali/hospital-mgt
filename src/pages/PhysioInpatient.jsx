...
const PhysioInpatient = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'Physiotherapist',
            responsive: ['sm'],

        },
        {
            title: 'Physio Remarks',
        ...
        },
        {
            ...
            dataIndex: 'Next Appointment Date',
            responsive: ['sm'],
        },
        {
            title: 'Frequency Duration',
            dataIndex: 'Frequency Duration',
            responsive: ['sm'],
        },
        {
            title: 'Completed',
    ...
    return (
        <div>
            <div className="d-flex justify-content-between aign-items center">
                <h5 className="card-title h4"><u>Nutrition List Outpatient</u></h5>
            ...
            <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
                ...
                <div className=" d-flex text-center gap-3">
                    <Link to='/Patient-Amdn' className="btn btn-primary"><PlusOutlined className='px-2' />New</Link>
...
export default PhysioInpatient;