...
import { UserOutlined, PlusOutlined, DeleteOutlined, ReloadOutlined } from '@ant-design/icons';
    ...
    return (
        <div>
            <div className="d-flex justify-content-between aign-items center">
                <h5 className="card-title h4"><u>Children Visits</u></h5>
            ...
            <div className="d-flex align-items-center justify-content-between gap-3 mb-3">
                ...
                <Link to='/Patient-Amdn' className="btn btn-primary"><PlusOutlined className='px-2' />New Admission</Link>
                    <Link to='/patient-list' className="btn btn-secondary">Patient List</Link>
